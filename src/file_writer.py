...
class FileWriter:
    ...
    def __init__(self, file_name:str):
        ...
        return
    def __create_constants_worksheet()-> None:
        work_sheet = self.__work_book.add_worksheet('Constants')
        column_labels = [
            "Name",
            "Path",
            "Data Type",
    ...
    def __create_plc_tags_worksheet(self)-> None:
        work_sheet = self.__work_book.add_worksheet('PLC Tags')
        column_labels = [
            "Name",
            "Path",
            "Data Type",
    ...
    def write_plc_tags(self, data:Tuple[TagTableRow, ...])-> None:
        ...
        """
        work_sheet = self.__work_book.get_worksheet_by_name('PLC Tags')
        for datum in data:
